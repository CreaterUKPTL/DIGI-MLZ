...
async def update_user_settings(query):
    ...
    if not ospath.exists(tpath):
        tpath = "https://graph.org/file/63b02f629e4e86138cd7c.jpg"
...
Examples:
1. <code>{escape('<b>Join: @DigiBotz</b>')}</code> 
This will give output as:
<b>Join: @DigiBotz</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @DigiBotz</code>')}</code> 
This will give output as:
<code>Join: @DigiBotz</code> <code>69MB.bin</code>.
